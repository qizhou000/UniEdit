...
#     ], ["%s is a"%subject_placeholder]
#     all_prompts = rewriting_prompts + kl_prompts

#     input_tok = tok(
#         [prompt.replace(subject_placeholder, request["subject"]) 
...
#             prompt, request["subject"], tok, hparams.fact_token, verbose=verbose,
...
#     sentence = prompt.replace(subject_placeholder, subject)
#     if verbose:
#         print(
